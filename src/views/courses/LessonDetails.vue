  ...
  <div class="d-flex flex-column enrolled">
    ...
    <div class="d-flex flex-column progress mt-56 ml-24">
      ...
      <div style="border-radius: 5px;" class="bg-grey-100 mt-12 mr-48">
        <div class="bg-grey-500" style="border-radius: 5px; height: 5px;" :style="{ width: '20%' }"></div>
      </div>
    </div>
    <div>
      <div class="p-12">
    ...
    <div class="mb-24 mx-24">
      <card-block name="eclipse" active resource="play" title="10 vital steps to take in carrying out the research" />
      <card-block name="eclipse" active resource="quiz" title="Assesment" />
      <card-block active resource="file" title="How to get rich" />
    </div>
    <sla-button @click="goToLesson" class="mx-32" type="outline" text="Start Lessonh" />
  </div>
</template>
<script>
export default {
