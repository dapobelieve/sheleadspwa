<template>
  <div
    class="pass d-flex flex-column justify-content-between mx-24"
    v-if="!isSent"
  >
    ...
    <span class="text-align-center mt-32"
      ...
      <router-link to="/reg/login" href="#">Click here</router-link></span
    >
  </div>
  <div class="pass d-flex flex-column justify-content-between mx-24" v-else>
    ...
    <span class="heading text-align-center font-poppins">
      Instructions have been sent to your email for you to reset your
      password</span
    >
  </div>
</template>
