<template>
  <div>
    ...
    <sla-noty
      text="Jane and 2 others just completed a course "
      ImageCount="multiple"
      :Images="[require('@/assets/img/0.png'), require('@/assets/img/0.jpg')]"
    >
    ...
    <card class="card" title=" About this Course">
      <p>
        ...
        research and how to analyse the results. We’ll then step through how to
        craft a meaningful problem definition statement.
      </p>
    </card>
